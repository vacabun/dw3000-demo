...
C_SRCS += \
../Drivers/Decawave/example/config_options.c 

OBJS += \
./Drivers/Decawave/example/config_options.o 

C_DEPS += \
./Drivers/Decawave/example/config_options.d 


# Each subdirectory must supply rules for building sources it contributes
Drivers/Decawave/example/%.o Drivers/Decawave/example/%.su: ../Drivers/Decawave/example/%.c Drivers/Decawave/example/subdir.mk
...
clean: clean-Drivers-2f-Decawave-2f-example

clean-Drivers-2f-Decawave-2f-example:
	-$(RM) ./Drivers/Decawave/example/config_options.d ./Drivers/Decawave/example/config_options.o ./Drivers/Decawave/example/config_options.su

.PHONY: clean-Drivers-2f-Decawave-2f-example
